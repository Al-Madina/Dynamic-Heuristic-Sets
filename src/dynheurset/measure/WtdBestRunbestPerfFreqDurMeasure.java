 ...
 */
public class WtdBestRunbestPerfFreqDurMeasure extends Measure{
    private final double w1;
    private final double w2;
    private final double w3;
    private final double w4;

    public WtdBestRunbestPerfFreqDurMeasure(double w1, double w2, double w3, double w4) {
        this.w1 = w1;
        this.w2 = w2;
        this.w3 = w3;
        this.w4 = w4;
    ...
    public double measure(int heurIdx) {
        ...
        return (w1*runStat.numBestImpr[heurIdx] + w2*runStat.numRunBestImpr[heurIdx]
                + w3*runStat.numImpr[heurIdx] - w4*runStat.numDisimpr[heurIdx])/runStat.durations[heurIdx];    
    }    
}

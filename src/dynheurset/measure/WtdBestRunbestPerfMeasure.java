 ...
 */
public class WtdBestRunbestPerfMeasure extends Measure{
    ...
    public WtdBestRunbestPerfMeasure(double w1, double w2, double w3, double w4) {
        this.w1 = w1;
        this.w2 = w2;
        this.w3 = w3;
        this.w4 = w4;
    ...
    public double measure(int heurIdx) {
        ...
        return w1*runStat.bestImpr[heurIdx] + w2*runStat.runBestImpr[heurIdx]
                + w3*runStat.impr[heurIdx] - w4*runStat.disimpr[heurIdx];    
    }

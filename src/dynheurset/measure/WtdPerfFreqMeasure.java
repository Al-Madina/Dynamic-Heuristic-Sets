 ...
 */
public class WtdPerfFreqMeasure extends Measure{
    private final double w1;
    private final double w2;

    public WtdPerfFreqMeasure(double w1, double w2) {
        this.w1 = w1;
        this.w2 = w2;
    }
    ...
    public double measure(int heurIdx) {
        ...
        //Larger is better
        return w1*runStat.numImpr[heurIdx] - w2*runStat.numDisimpr[heurIdx];
    }

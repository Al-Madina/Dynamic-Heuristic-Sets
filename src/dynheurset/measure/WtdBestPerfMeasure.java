 ...
 */
public class WtdBestPerfMeasure extends Measure{
    private final double w1;
    private final double w2;
    private final double w3;

    public WtdBestPerfMeasure(double w1, double w2, double w3) {
        this.w1 = w1;
        this.w2 = w2;
        this.w3 = w3;
    }
    ...
    public double measure(int heurIdx) {
        ...
        //Larger is better
        return w1*runStat.bestImpr[heurIdx] + w2*runStat.impr[heurIdx] - w3*runStat.disimpr[heurIdx];    
    }
